public class Main {
    ...
    public static void main(String[] args) {
        ...
        Wolf angelawolf = new Wolf( 2);

        Action action = new Action(Method.Attack, "Action", 'a', null);

        System.out.println(Method.Flee);
        System.out.println(Method.Attack);
        System.out.println(Method.ViewInventory);
        System.out.println(Method.MoveEast);
        System.out.println(Method.MoveWest);
        System.out.println(Method.MoveSouth);
        System.out.println(Method.MoveNorth);
        System.out.println(Method.Walking);
